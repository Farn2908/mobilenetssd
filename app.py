...
lineaccesstoken='rSWX+/S6zFh7+3oYe0nCKwWJIrlXZzr2SNNaryLJoPiZvWUThb6yYGibhzZQ38kgz47K05gK6t5mX8qu6/aISA0aC9dpHzci6D5OewuthWmxT+oSGAqAn6Iqap1AcsPjU0p7/eLlRAZilJLjSprdOgdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
            ...
            replyObj = TextSendMessage(text="ก็ดีอยู่")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg=="กินข้าวกันมั้ย"):
            replyObj = TextSendMessage(text="ไม่ดีกว่า")
            line_bot_api.reply_message(rtoken, replyObj)
        else:
            headers = request.headers 
            json_headers = ({k:v for k, v in headers.items()}) 
            json_headers.update({'Host':'bots.dialogflow.com'}) 
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/e613e63a-81f5-42d8-a21a-f9d9ebd5b475"
